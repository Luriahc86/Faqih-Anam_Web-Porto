...
import { initGA, trackPageView, trackButtonClick, trackDownload } from './utils/analytics';
...
function App() {
  ...
  const scrollToSection = (sectionId: string) => {
    ...
    trackButtonClick('scroll_to_section', sectionId);
  };
  ...
  const handleDownloadCV = () => {
    trackDownload('cv-faqih-chairul-anam.pdf');
    const link = document.createElement('a');
    link.href = '/cv-faqih-chairul-anam.pdf';
    link.download = 'CV-Faqih-Chairul-Anam.pdf';
    link.click();
  };
            ...
            <div className="relative z-10 text-center px-6 mt-16">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in-delay-3">
                ...
                <button 
                  ...
                  className="border border-gray-600 hover:border-blue-400 px-8 py-4 rounded-xl font-semibold transition-all duration-300 transform hover:scale-105 hover:bg-gray-800/50 flex items-center gap-2 btn-animated hover-glow"
                >
                  <Download size={20} />
                  Download CV
                </button>
                    ...
                    <div className="space-y-4">
                      {[
                        ...
                        <a
                          ...
                          onClick={() => trackButtonClick('social_link', social.label)}
                        >
